...
Route::group(['as'=>'admin.','prefix'=>'admin','namespace'=>'Admin','middleware'=>['auth','admin','disablepreventback']],function () {
    /*new route form event*/
    Route::resource('/manage-envent-type', 'EventTypeController');
    Route::resource('/manage-venu', 'VenuController');
    Route::resource('/manage-equipment', 'EquipmentController');
    Route::resource('/manage-decoration', 'DecorationController');
    Route::resource('/manage-drinks', 'DrinksController');
    Route::resource('/manage-food', 'FoodController');
    Route::resource('/manage-order', 'OrderController');
    Route::post('complete-transaction', 'OrderController@completeTransaction')->name('complete-transaction.store');
    Route::post('manage-order/{id}', 'OrderController@orderSattus')->name('order_status.store');
    /*new route form event*/
...
Route::group(['as'=>'user.','prefix' => 'user','namespace'=>'User'], function() {
    ...
    Route::get('collection/{id}', 'PhotographerController@collection')->name('collection.show');
        /*new route form event*/
    Route::resource('/event-reservation', 'ReservationController');
    /*new route form event*/
    Route::resource('/contact', 'ContactController');
    Route::get('/services', 'ContactController@services')->name('services.create');
    Route::get('/teams', 'ContactController@our_team')->name('teams.create');
