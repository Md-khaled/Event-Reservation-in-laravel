      ...
      <div class="col-xs-12">
        <div class="card card-data-tables product-table-wrapper">
          <header class="card-heading">
            <h2 class="card-title">Manage Decoration </h2>
              @if(session()->has('msg'))
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th class="col-xs-2">Decoration Type</th>
                    ...
                    <th data-orderable="false" class="col-xs-1">
                      <button class="btn btn-primary btn-fab  animate-fab" data-toggle="modal" data-target="#decoration_add_modal"><i class="zmdi zmdi-plus"></i></button>
                    </th>
                ...
                <tbody id="rowadd">
                  ...
                  <tr>
                    ...
                    <td>{{date('d-m-Y', strtotime($decoration->created_at))}}</td>
                    <td >
                        <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                          <li role="presentation">
                            <a style="padding-left: 2px !important" href="{{route('admin.manage-decoration.edit',$decoration->id)}}"><i class="zmdi zmdi-edit"></i></a>
                          </li>
                          <li role="presentation">
                           <form action="{{route('admin.manage-decoration.destroy',$decoration->id)}}" method="post" onsubmit="return confirm('Are you sure?');">
                             @csrf
                             @method('DELETE')
...
<!--modal product add-->
<div class="modal fade" id="decoration_add_modal" tabindex="-1" role="dialog" aria-labelledby="tab_modal">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header p-b-15">
              
              <h4 class="modal-title">Decoration Setup</h4>
              <ul class="card-actions icons right-top">
              ...
              <div class="tab-content">
                <div class="tab-pane fadeIn active" id="product_add_general">
                  <div class="card card p-20 p-t-10 m-b-0">
                    <div class="card-body">
                      <form class="form-horizontal" action="{{route('admin.manage-decoration.store')}}" method="post" enctype="multipart/form-data" id="createDecoration">
                        @csrf
                       ...
                       <div class="form-group label-floating is-empty">
                          <label class="control-label">Decoration Cost</label>
