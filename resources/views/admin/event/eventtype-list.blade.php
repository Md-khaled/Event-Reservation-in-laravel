        ...
        <div class="col-xs-12">
          <header id="header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="{{route('admin.manage-envent-type.index')}}">Event</a></li>
      ...
      <div class="col-xs-12">
        <div class="card card-data-tables product-table-wrapper">
          <header class="card-heading">
            <h2 class="card-title">Manage Event Type</h2>
              @if(session()->has('msg'))
              ...
              <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                ...
                <tbody id="rowadd">
                  ...
                  <tr>
                    ...
                    <td><img src="{{asset($EventType->image)}}" alt="" class="img-thumbnail" /></td>
                    <td>{{date('d-m-Y', strtotime($EventType->created_at))}}</td>
                    <td >
                        <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                          <li role="presentation">
                            <a style="padding-left: 2px !important" href="{{route('admin.manage-envent-type.edit',$EventType->id)}}"><i class="zmdi zmdi-edit"></i></a>
                          </li>
                          <li role="presentation">
                           <form action="{{route('admin.manage-envent-type.destroy',$EventType->id)}}" method="post" onsubmit="return confirm('Are you sure?');">
                             @csrf
                             @method('DELETE')
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header p-b-15">
              ...
              <h4 class="modal-title">Event Setup</h4>
              <ul class="card-actions icons right-top">
              ...
              <div class="tab-content">
                <div class="tab-pane fadeIn active" id="product_add_general">
                  <div class="card card p-20 p-t-10 m-b-0">
                    <div class="card-body">
                      <form class="form-horizontal" action="{{route('admin.manage-envent-type.store')}}" method="post" enctype="multipart/form-data" id="createEventtype">
                        @csrf
